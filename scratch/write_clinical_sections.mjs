...
const filePath = path.resolve('c:/Users/adiis/Desktop/New folder/medikiosk/src/data/clinicalSections.js')
...
console.log('src/data/clinicalSections.js written successfully')
